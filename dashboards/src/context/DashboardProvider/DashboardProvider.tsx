...
import { usePlugin, usePluginRegistry } from '@rafaysystems-perses/plugin-system';
import { DashboardKind, DashboardResource, ProjectMetadata } from '@rafaysystems-perses/client';

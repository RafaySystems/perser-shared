...
import { ChartsProvider, SnackbarProvider, testChartsTheme } from '@rafaysystems-perses/components';
import { mockPluginRegistry, PluginRegistry } from '@rafaysystems-perses/plugin-system';

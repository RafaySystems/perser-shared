...
import { Checkbox, IconButton, InputAdornment, ListItemText, Menu, MenuItem, Stack, Tooltip } from '@rafaysystems/components/compat/mui';
import { Column } from '@tanstack/react-table';
import { ReactElement, useCallback, useState } from 'react';
import { Magnify } from '@rafaysystems/components/compat/icons';
import { Close } from '@rafaysystems/components/compat/icons';
import { ViewColumn } from '@rafaysystems/components/compat/icons';
import { UnfoldMore } from '@rafaysystems/components/compat/icons';
import { UnfoldLess } from '@rafaysystems/components/compat/icons';
